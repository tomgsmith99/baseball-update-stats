...
function get_owner_drop_down_list($season, $form_type='hash') {
	global $dbconn;
	...
	if ($form_type === 'post') {
		$owner_drop_down_row = file_get_contents(HTML_PATH . "/owner_drop_down_row_post.html");
	}
	else {
		$owner_drop_down_row = file_get_contents(HTML_PATH . "/owner_drop_down_row_hash.html");
	}
